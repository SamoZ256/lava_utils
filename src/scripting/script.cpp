...
void Script::init(const char* aFilename) {
    ...
    cmd = "g++ -std=c++20 " + filename + " -o " + libFilename + " -Wno-deprecated-volatile -fPIC -shared -I src -I /Users/samuliak/Documents/lava_utils/include/lvutils/entity -I external/entt/src -I /opt/homebrew/Cellar/glm/0.9.9.8/include -I /Users/samuliak/Documents/lava_window/include -L /Users/samuliak/Documents/lava_window/lib -llvnd";
