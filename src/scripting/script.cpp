...
void Script::init(const char* aFilename) {
    ...
    cmd = "g++ -std=c++20 " + filename + " -o " + libFilename + " -Wno-deprecated-volatile -fPIC -shared -I /Users/samuliak/Documents/lava_utils/1.3/include/lvutils/scripting -I /Users/samuliak/Documents/entt/include -I /opt/homebrew/Cellar/glm/0.9.9.8/include -I /Users/samuliak/Documents/lvnd/include -L /Users/samuliak/Documents/lvnd/lib/nobackend -llvnd";
